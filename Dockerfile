...
# Install OSG WN base
# Install ganglia
RUN yum -y install http://linuxsoft.cern.ch/cern/slc64/x86_64/yum/extras/HEP_OSlibs_SL6-1.0.16-0.el6.x86_64.rpm condor yum-plugin-priorities https://repo.grid.iu.edu/osg/3.3/osg-3.3-el6-release-latest.rpm osg-wn-client wget rsync nano ganglia-gmond fuse fuse-libs ; yum clean all
